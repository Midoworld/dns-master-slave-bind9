...
variable "nic_resource_group_name" {
  default = "apps-smz-sand1-rg1"
}

variable "subnets_ids" {
  type    = "list"
  default = ["/subscriptions/xxx-subscription_id-xxx/resourceGroups/apps-smz-sand1-rg1/providers/Microsoft.Network/virtualNetworks/myvnet/subnets/mysubnet"]
}

variable "lb_backend_ids" {
  type    = "list"
  default = ["/subscriptions/xxx-subscription_id-xxx/resourceGroups/apps-smz-sand1-rg1/providers/Microsoft.Network/loadBalancers/lbname/backendAddressPools/bckpoolname"]
}
...
variable "nsgs_ids" {
  type    = "list"
  default = ["/subscriptions/xxx-subscription_id-xxx/resourceGroups/apps-smz-sand1-rg1/providers/Microsoft.Network/networkSecurityGroups/nsgname"]
}
